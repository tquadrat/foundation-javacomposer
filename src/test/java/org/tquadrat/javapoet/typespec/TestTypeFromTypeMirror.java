...
@DisplayName( "TestTypeFromTypeMirror" )
public final class TestTypeFromTypeMirror
{
        /*------------*\
    ====** Attributes **=======================================================
        \*------------*/
    ...
    public void typeFromTypeMirror()
    {
        ...
        final var mirror = getElement( String.class ).asType();
        assertThat( composer.codeBlockOf( "$T", mirror ).toString() ).isEqualTo( "java.lang.String" );
    }   //  typeFromTypeMirror()
}
//  class TestTypeFromTypeMirror
