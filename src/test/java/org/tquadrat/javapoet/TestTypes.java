...
@DisplayName( "TestTypes" )
@RunWith( JUnit4.class )
public final class TestTypes extends AbstractTypes
{
        /*------------*\
    ====** Attributes **=======================================================
        \*------------*/
    ...
    {
        Elements retValue = null;
        try
        {
            retValue = m_Compilation.getElements();
        }
    ...
    protected final Types getTypes()
    {
        ...
        try
        {
            retValue = m_Compilation.getTypes();
        }
        catch( @SuppressWarnings( "unused" ) final IllegalStateException e ) {/* Deliberately ignored */}
        assumeFalse( isNull( retValue ) );
