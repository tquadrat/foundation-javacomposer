...
public final class ClassNameImpl extends TypeNameImpl implements ClassName
{
    ...
    public static final ClassNameImpl from( final Class<?> sourceClass )
    {
        ...
        requireValidArgument( validatedClass, "sourceClass", v -> !v.isPrimitive(), (_,_) -> "primitive types cannot be represented as a ClassName" );
        requireValidArgument( validatedClass, "sourceClass", v -> !void.class.equals( v ), (_,_) -> "'void' type cannot be represented as a ClassName" );
        requireValidArgument( validatedClass, "sourceClass", v -> !v.isArray(), (_,_) -> "array types cannot be represented as a ClassName" );
